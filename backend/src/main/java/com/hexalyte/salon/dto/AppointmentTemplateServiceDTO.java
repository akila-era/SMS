...
public class AppointmentTemplateServiceDTO {
    ...
    // Constructors
    public AppointmentTemplateServiceDTO() {}

    public AppointmentTemplateServiceDTO(Long serviceId, BigDecimal price, BigDecimal commissionRate) {
